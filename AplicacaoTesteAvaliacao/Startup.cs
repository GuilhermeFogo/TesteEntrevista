using AplicacaoTesteAvaliacao.Repository;
using AplicacaoTesteAvaliacao.Repository.Interfaces;
using AplicacaoTesteAvaliacao.Service;
...
namespace AplicacaoTesteAvaliacao
{
    public class Startup
    {
        ...
        private void InjectionDependency(IServiceCollection services)
        {
